...
import PrivacySelecctor from '../components/my-account/PrivacySelector';
import ThemeSelector from '../components/my-account/ThemeSelector';
...
const Settings = () => {
  ...
  const privacy_security: { option: string; desc: string; value: boolean }[] = [
    ...
    {
      option: 'Show Activity Status',
      desc: 'Let other see when you are active',
      value: true,
    },
  ];
